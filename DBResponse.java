...
public class DBResponse {
    ...
    static void deletePostResponse(RequestQueue q, int seedid, int id, Response.Listener<String> listener){
        postDBResponse res = new postDBResponse(URL+ "deletePost.php", seedid, id, listener);
        q.add(res);
        //Return String "-1","1"
    }//댓글 작성
    ...
    static class postDBResponse extends StringRequest {
        ...
        public postDBResponse(String url, int seedid, int id, Response.Listener<String> listener) {
            super(Method.POST, url, listener, null);
            map = new HashMap<>();
            map.put("seedid", ""+seedid);
            map.put("id", ""+id);
